...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  const sortedHotels = hotels.sort((a, b) => {
    return reviews === 'least-to-most' ? a.reviews - b.reviews : b.reviews - a.reviews;
  });
  res.json({ hotels: sortedHotels });
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  const filteredHotels = hotels.filter(hotel => hotel.amenity.toLowerCase() === amenity.toLowerCase());
